...
変数一覧 (Scope Variables) ウィンドウの表示.

    :Cdbgvar

変数一覧ウィンドウのオブジェクトなどの展開は、
ウィンドウの該当行へカーソルを移動し `<S-X>` を押下.
...
`Cdbgvar` による表示はまだ結構おかしいのです.
また、このウィンドウでも日本語とかを表示すると表示がくずれます.
...
* Cdbgvar コマンドによる変数一覧表示(まだあまりうまく動かない版).
